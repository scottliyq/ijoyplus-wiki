...
define("app_siteurl","maccms.ijoyplus.com");        //网站域名地址
...
define("app_cacheid","1341896373");      //缓存标示
...
define("app_dbname","ijoyplus");      					  //SQL数据库名称
define("app_dbuser","root");      //SQL数据库用户名
define("app_dbpass","ilovetv001");      					  //SQL数据库密码
...
define("app_vodplayviewtype",0);        //视频播放页 浏览模式, 0=仿伪静态模式,1=asp动态模式,2=rewrite伪静态,3=生成单页,4=生成每集一页,5=生成每组一页
